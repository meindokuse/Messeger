...
import com.example.friendnet.ui.chats.rcview.UsersListener
import com.example.friendnet.databinding.EventItemBinding
import com.example.friendnet.databinding.UserForChooseBinding
...
class UniversalAdapter<T>(val itemListener: UsersListener, val key: String) :
    ...
    inner class UserForMessege(item: View):RecyclerView.ViewHolder(item){
        ...
        fun bind(userForChoose: UserForChoose,position: Int){
            ...
            Log.d("MyLog","фото на firebase for userForChoose ${userForChoose.foto}")
            ...
            binding.firstNameRemoteUser.text = userForChoose.firstName
            binding.secondNameRemoteUser.text = userForChoose.secondName
